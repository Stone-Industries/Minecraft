...
Last README file update: Fri Apr 30 09:38:07 PDT 2021
...
command.dmap.args
command.dmarker
command.dmarker.args
command.dumpHandlers
command.dumpNBT
command.dynmap
command.dynmap.args
command.dynmapexp
command.dynmapexp.args
command.effect
...
command.mcmt
command.mcmt.config
command.mcmt.config.save
command.mcmt.config.state
command.mcmt.config.temanage
command.mcmt.config.temanage.list
command.mcmt.config.temanage.target
command.mcmt.config.temanage.target.blacklist
command.mcmt.config.temanage.target.remove
command.mcmt.config.temanage.target.whitelist
command.mcmt.config.temanage.target.willtick
command.mcmt.config.toggle
command.mcmt.config.toggle.chunkprovider
command.mcmt.config.toggle.entity
command.mcmt.config.toggle.environment
command.mcmt.config.toggle.te
command.mcmt.config.toggle.world
command.mcmt.debug
command.mcmt.debug.classpathDump
command.mcmt.debug.getBlockState
command.mcmt.debug.getBlockState.location
command.mcmt.debug.nbtdump
command.mcmt.debug.nbtdump.location
command.mcmt.debug.tick
command.mcmt.debug.tick.location
command.mcmt.debug.tick.te
command.mcmt.stats
command.mcmt.stats.reset
command.mcmt.stats.startlog
command.mcmt.stats.stoplog
command.mcmt.stats.toggle
command.me
command.me.action
command.mek
command.mek.build
